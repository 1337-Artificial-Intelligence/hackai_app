    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            10:30 Coffee break & Networking session
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            11:00 AI Conference 2
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            12:00 Lunch
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            15:15 Presentation of challenges
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            16:00 Start hacking
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            15:00 Distribution of awards
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">
            15:45 Networking Session Coffee break
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs sm:text-sm md:text-base font-normal mb-6 sm:mb-8">

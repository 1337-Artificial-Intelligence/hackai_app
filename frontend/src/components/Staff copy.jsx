  ...
  return (
    <section className="bg-white dark:bg-black/50">
      ...
      <div className="my-8  mx-auto  rounded-md w-full lg:my-10 dark:bg-neutral-950 py-7">
        ...
        {/* <div className="grid gap-8 lg:gap-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center"> */}
        <div className="flex gap-8 lg:gap-10 flex-wrap justify-between items-center">
